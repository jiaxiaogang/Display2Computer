...
Copy-Item -Path (Join-Path $Root "stop.bat") -Destination $PackageDir -Force
...
'@
Set-Content -Path (Join-Path $PackageDir "run-silent.vbs") -Value $RunSilent -Encoding ASCII
